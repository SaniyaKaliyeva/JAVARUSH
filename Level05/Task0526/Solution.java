...
public class Solution {
    public static void main(String[] args) {
        Man man1 = new Man("Sam", 34, "Abay street, 54");
        Man man2 = new Man("Rob", 28, "Abay street, 53");
        System.out.println(man1.name + " " + man1.age + " " + man1.address);
        System.out.println(man2.name + " " + man2.age + " " + man2.address);

        Woman woman1 = new Woman("Sara", 28, "51th avenue");
        Woman woman2 = new Woman("Karry", 32, "51th avenue");
