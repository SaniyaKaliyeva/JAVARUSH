...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < list.size(); i++) {
            if(list.get(i) % 3 == 0 && list.get(i) % 2 == 0) { list3.add(list.get(i)); list2.add(list.get(i)); }
            else if (list.get(i) % 3 == 0 && list.get(i) % 2 != 0) list3.add(list.get(i));
            else if (list.get(i) % 3 != 0 && list.get(i) % 2 == 0) list2.add(list.get(i));
